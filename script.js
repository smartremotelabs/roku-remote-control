// ============================================
// Aruk: TV Remote - Main JavaScript
// ============================================
...
console.log('%c📺 Aruk: TV Remote', 'font-size:16px; font-weight:800; color:#2563EB;');
console.log('%c  Free TV remote for Android — smartremotelabs.github.io', 'font-size:12px; color:#888;');
